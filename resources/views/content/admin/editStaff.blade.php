                    ...
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                @endif
                                <form method="post" enctype="multipart/form-data" action="{{ URL::to('/editStaffProgress') }}">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="id" value="{{ $T->users_id }}" />
                            </div>

                            <div class="col-lg-3" align="center">
                                <img src="{{ URL::to('/assets/img/staff-img/'.$T->staff_image) }}" class="img-thumbnail" />
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <label>Jabatan Staff (Indonesia)</label>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" value="{{ $T->staff_jabatan_id }}" name="jabatan_id" id="jabatan_id" class="form-control" placeholder="Masukan Jabatan (Indonesia)" minlength="5" required>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-lg-6">
                                        <label>Jabatan Staff (Inggris)</label>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="jabatan_en" value="{{ $T->staff_jabatan_en }}" id="jabatan_en" class="form-control" placeholder="Masukan Jabatan (Inggris)" minlength="5" required>
                                            </div>
                                        </div>
                                    </div>
