...
<head>
    ...
    <!-- Title -->
    <title>
        404 - Sekolah Tinggi Manajemen Informatika &amp; Komputer Bandung (STMIK Bandung)
    </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mt-50 mb-50 text-center">
                    <h1 class="text-light mb-5 wow fadeInUp" data-wow-delay="100ms" style="font-size: 100px">404</h1>
                    <hr class="bg-yellow wow fadeInUp" data-wow-delay="150ms" />
                </div>
                <div class="col-12 text-center">
                    <h4 class="text-light wow fadeInLeft" data-wow-delay="200ms">Halaman Tidak Ditemukan</h4>
                    <p class="text-light wow fadeInRight" data-wow-delay="200ms">Maaf, halaman yang Anda minta tidak ditemukan.</p>
